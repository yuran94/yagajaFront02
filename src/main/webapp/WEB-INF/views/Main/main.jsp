...
<body data-reactid="26" cz-shortcut-listen="true">
	<div id="app" data-reactid="34" >
		<div data-reactroot data-reactid="1">
			<div class="app-content" data-reactid="2">
				<div class="site-wrapper pc-wrapper" data-reactid="6" >
					<div id="main" class="container-comm pc-container" data-reactid="82">
						<article class="contents" data-reactid="83">
							<div class="home-content" data-reactid="84" >
								<div data-reactid="85">
									<section class="search-area background2" data-reactid="86">
										<h2 class="sc-out" data-reactid="87">검색 영역</h2>
										<div class="search-panel column1" data-reactid="88">
										
											<!-- 사진배경화면에 글씨 부분  -->
											<p class="search-paragraph" data-reactid="89">
												<!--  -->
												야가자와 함께
												<!--  -->
												<br data-reactid="91">
												<em data-reactid="92">여행</em>
												<!--  -->
												을 떠나볼까요?
												<!--  -->
											</p>
											<div class="search-option" data-reactid="94">
												<div class="option-list" data-reactid="95" >
													<div class="option-item item-option-roomtype" data-reactid="96">
														<div class="option-tit-rap" data-reactid="97">
															<span class="option-tit" data-reactid="98" >숙박유형</span>
														</div>
														<span data-reactid="99">
															<div class="popover-wrapper" data-reactid="100">
																<div class="popover-container-pc" data-reactid="101">
																	<div data-popover-children="true" data-reactid="102" >
																		<button type="button" class="option-btn" data-reactid="103">
																			<img src="https://yaimg.yanolja.com/joy/pw/home/img-roomtype-1.svg" alt data-reactid="104">
																				<em data-reactid="105">모텔</em>
																				<i class="icon-comm icon-arrow-down" data-reactid="106">
																				</i>
																		</button>
																	</div>
																	<div style="display:none;" class="popover-content popover-search-option animate-bounce-down"
																		data-popover-content="true" data-reactid="107">
																		<div class="layer-search-option layer-radio-list" data-reactid="108">
																			<div class="radio-list" data-reactid="109">
																				<div class="inp-radio inp-radio-active">
																					<input type="radio" title="모텔" name="inp-radio" value="on">
																						<label for="inp-radio">
																							<a>모텔</a>
																						</label>
																				</div>
													...
													<div class="option-item item-option-area" data-reactid="110">
														<div class="option-tit-rap" data-reactid="111">
															<span class="option-tit" data-reactid="112" >지역</span>
														</div>
															<span data-reactid="113">
														<div class="popover-wrapper" data-reactid="114">
																<div class="popover-container-pc" data-reactid="115">
																	<div data-popover-children="true" data-reactid="116">
																		<button type="button" class="option-btn" data-reactid="117">
																			<em data-reactid="118">서울</em>
																			<span data-reactid="119">강남/역삼/삼성/논현</span>
																				<i class="icon-comm icon-arrow-down" data-reactid="120"></i>
																		</button>
																	</div>
